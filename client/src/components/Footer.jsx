                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
                    ...
                    <div className="md:col-span-3 space-y-6">
                        ...
                        <ul className="space-y-3 font-typewriter text-sm text-gray-400">
                             {['Events', 'Register', 'Contact Command', 'Sponsors'].map((item) => (
                                <motion.li 
                                    key={item}
                    ...
                    <div className="md:col-span-4 space-y-6">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <SocialLink 
                                href="#" 
                                label="DISCORD // HAWKINS_AV" 
                                icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.928 11.607c-.208-.488-3.04-6.495-9.928-6.495-6.888 0-9.72 6.007-9.928 6.495-.102.241-.102.518 0 .759.208.488 3.04 6.495 9.928 6.495 6.888 0 9.72-6.007 9.928-6.495.102-.241.102-.518 0-.759zM12 16.5c-2.485 0-4.5-2.015-4.5-4.5s2.015-4.5 4.5-4.5 4.5 2.015 4.5 4.5-2.015 4.5-4.5 4.5z"/></svg>} 
                            />
                            <SocialLink 
                                href="#" 
                                label="EMAIL // S.O.S." 
