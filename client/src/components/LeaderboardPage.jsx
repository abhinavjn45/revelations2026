...
export default function LeaderboardPage({ startAnimation = false }) {
  ...
  const getRankStyle = (row) => {
    ...
    if (row.rank === 0 && uniqueNonZeroRanks.length >= 1) {
      return {
        className:
          "bg-gradient-to-r from-yellow-500/20 via-yellow-400/10 to-yellow-500/20 border-yellow-500/50 shadow-[0_0_30px_rgba(255,215,0,0.3)]",
        icon: (
      ...
      return {
        className:
          "bg-gradient-to-r from-gray-400/20 via-gray-300/10 to-gray-400/20 border-gray-400/50 shadow-[0_0_24px_rgba(192,192,192,0.25)]",
        icon: (
      ...
      return {
        className:
          "bg-gradient-to-r from-amber-600/20 via-amber-500/10 to-amber-600/20 border-amber-500/50 shadow-[0_0_20px_rgba(205,127,50,0.25)]",
        icon: (
    ...
    return {
      className: "bg-gray-900/30 border-gray-700",
      icon: null,
    ...
    <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
      ...
      <main className="relative z-10 pt-32 pb-20 px-4 md:px-8">
        <div className="w-full max-w-none mx-auto overflow-x-auto">
          ...
          >
            <h1 className="font-stranger text-[2rem] md:text-7xl text-red-600 tracking-widest mb-4 drop-shadow-[0_0_30px_rgba(220,38,38,0.5)]">
              LEADERBOARD
            </h1>
            {loading && (
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative w-9 h-9 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-gray-600 via-gray-400 to-gray-600 flex items-center justify-center border-2 border-gray-300/50 shadow-[0_0_15px_rgba(156,163,175,0.5)]">
                      <span className="font-stranger text-base md:text-lg text-gray-900 drop-shadow-lg">
                        2
                      </span>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <span className="font-stranger text-sm md:text-base text-white">
                      {rankedRows[1].points}
                    </span>
                    <span className="font-typewriter text-[10px] text-gray-500">
                      PTS
                    </span>
                  </motion.div>
                  ...
                  <div className="relative">
                    {/* Tendril decorations */}
                    <svg
                      className="absolute -left-4 top-0 w-8 h-full opacity-30"
                      viewBox="0 0 20 100"
                      fill="none"
                    >
                      <path
                        d="M15 0 Q5 20 10 40 Q15 60 8 80 Q2 100 5 120"
                        stroke="url(#tendril-gray)"
                        strokeWidth="2"
                        fill="none"
                      />
                    </svg>
                    <svg
                      className="absolute -right-4 top-0 w-8 h-full opacity-30"
                      viewBox="0 0 20 100"
                      fill="none"
                    >
                      <path
                        d="M5 0 Q15 25 10 50 Q5 75 12 100"
                        stroke="url(#tendril-gray)"
                        strokeWidth="2"
                        fill="none"
                      />
                    ...
                    >
                      ...
                      <span className="font-stranger text-3xl md:text-4xl text-gray-400 drop-shadow-lg">
                        II
                      </span>
                      <span className="font-typewriter text-[10px] text-gray-400 mt-1 tracking-wider">
                        SECOND
                      </span>
                    </motion.div>
                  </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-red-500 via-red-600 to-red-800 flex items-center justify-center border-2 border-red-400/70 shadow-[0_0_30px_rgba(220,38,38,0.6),0_0_60px_rgba(220,38,38,0.3)]">
                      ...
                      <span className="font-stranger text-xl md:text-2xl text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)] relative z-10">
                        1
                      </span>
                    </div>
                  ...
                  >
                    ...
                    />
                    <span className="font-stranger text-base md:text-lg text-white">
                      {rankedRows[0].points}
                    </span>
                    <span className="font-typewriter text-[10px] text-red-400">
                      PTS
                    </span>
                  </motion.div>
                  ...
                  <div className="relative">
                    ...
                    <svg
                      className="absolute -left-4 top-0 w-8 h-full opacity-40"
                      viewBox="0 0 20 120"
                      fill="none"
                    >
                      <path
                        d="M18 0 Q5 30 12 60 Q18 90 8 120"
                        stroke="url(#tendril-red)"
                        strokeWidth="2"
                        fill="none"
                      />
                      <path
                        d="M15 20 Q8 40 12 60"
                        stroke="url(#tendril-red)"
                        strokeWidth="1.5"
                        fill="none"
                      />
                    ...
                    <svg
                      className="absolute -right-4 top-0 w-8 h-full opacity-40"
                      viewBox="0 0 20 120"
                      fill="none"
                    >
                      <path
                        d="M2 0 Q15 30 8 60 Q2 90 12 120"
                        stroke="url(#tendril-red)"
                        strokeWidth="2"
                        fill="none"
                      />
                    ...
                    >
                      ...
                      <span className="font-typewriter text-[10px] text-red-400 mt-1 tracking-widest">
                        CHAMPION
                      </span>
                    </motion.div>
                  </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative w-8 h-8 md:w-9 md:h-9 rounded-full bg-gradient-to-br from-amber-600 via-amber-500 to-amber-700 flex items-center justify-center border-2 border-amber-400/50 shadow-[0_0_15px_rgba(217,119,6,0.5)]">
                      <span className="font-stranger text-sm md:text-base text-amber-900 drop-shadow-lg">
                        3
                      </span>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <span className="font-typewriter text-[10px] text-amber-600">
                      PTS
                    </span>
                  </motion.div>
                  ...
                  <div className="relative">
                    {/* Tendril decorations */}
                    <svg
                      className="absolute -left-3 top-0 w-6 h-full opacity-25"
                      viewBox="0 0 20 80"
                      fill="none"
                    >
                      <path
                        d="M15 0 Q8 20 12 40 Q16 60 10 80"
                        stroke="url(#tendril-amber)"
                        strokeWidth="1.5"
                        fill="none"
                      />
                    </svg>
                    <svg
                      className="absolute -right-3 top-0 w-6 h-full opacity-25"
                      viewBox="0 0 20 80"
                      fill="none"
                    >
                      <path
                        d="M5 0 Q12 25 8 50 Q4 75 10 100"
                        stroke="url(#tendril-amber)"
                        strokeWidth="1.5"
                        fill="none"
                      />
                    ...
                    >
                      ...
                      <span className="font-stranger text-2xl md:text-3xl text-amber-500 drop-shadow-lg">
                        III
                      </span>
                      <span className="font-typewriter text-[10px] text-amber-400 mt-1 tracking-wider">
                        THIRD
                      </span>
                    </motion.div>
                  </div>
          ...
          {/* Leaderboard Table */}
          <motion.div
            className="overflow-y-auto bg-gradient-to-br from-gray-900/80 via-[#1a0505]/60 to-gray-900/80 border border-red-900/30 rounded-2xl p-6 md:p-8 backdrop-blur-sm shadow-[0_0_60px_rgba(220,38,38,0.15)] overflow-x-auto w-full"
            initial={{ opacity: 0, y: 30 }}
            animate={
              startAnimation ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }
            }
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="text-center min-w-[140px] flex-1">
                  2nd Runner Up
                </div>
                  ...
                  >
                    ...
                    <div className="text-center min-w-[70px] flex-1 flex justify-center">
                      {style.icon ? (
                        ...
                        <span className="font-typewriter text-2xl text-gray-500">
                          #{row.rank + 1}
                        </span>
                      )}
                    </div>
                    ...
                    {/* Division Name */}
                    <div
                      className={`min-w-[180px] flex-1 font-typewriter text-lg md:text-xl ${style.textClass || "text-gray-300"}`}
                    >
                      {row.team}
                    </div>
                    ...
                    {/* Total */}
                    <div
                      className={`text-center min-w-[100px] flex-1 font-stranger text-2xl md:text-3xl ${row.points > 0 ? "text-red-400" : "text-gray-600"}`}
                    >
                      {row.points}
                    </div>
                  </motion.div>
